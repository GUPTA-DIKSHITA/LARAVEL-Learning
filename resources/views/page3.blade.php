...
@section('content')
<form action="{{url('/')}}/form/page3" method="post">
   @csrf
   <div class="container">
      <br><h2 class="text-black-50" >3. RAMP-UP CAPABILITIES</h2> 
      <br><h5>3.1 Are you satised with Eminenture's Ramp Up capabilities?</h5>
      ...
      <tbody>
         <tr>
            <th scope="row">ENTHUSIASM OF<br>PROJECT</th>
         ...
         <tr>
            <th scope="row">QUALITY OF<br>RESOURCES AT<br>ALL LEVELS</th>
         ...
         <tr>
            <th scope="row">FLEXIBILITY TO HANDLE<br>DYNAMIC CLIENT<br>REQUIREMENTS</th>
         ...
         <tr>
            <th scope="row">ONTIME RAMPS AS<br>PER PLAN</th>
